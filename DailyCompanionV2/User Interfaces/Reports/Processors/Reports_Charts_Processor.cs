...
namespace DailyCompanionV2.User_Interfaces.Reports
{
    public static partial class Reports_Processor
    {
        ...
        public static void PrepareChart(LiveCharts.WinForms.CartesianChart chart, List<DateTime> dateTimes)
        {
            chart.Visible = false;
            chart.Series.Clear();
        ...
        public static List<DateTime> getDateList(DateTime from, DateTime to, Enums.Span Span,int Rng = 0)
        {
            switch (Span)
            {
        ...
        public static void PreparePieChart(LiveCharts.WinForms.PieChart pieChart)
        {
